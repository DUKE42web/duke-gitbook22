...
- We have our 3 tasks, arranged in an un-ordered list. Each task is a list item ([`<li>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/li)), and has buttons to edit and delete it and a checkbox to check it off as done.
