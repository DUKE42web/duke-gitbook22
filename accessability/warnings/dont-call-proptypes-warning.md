...
#### Declaring PropTypes is still fine <a href="#declaring-proptypes-is-still-fine" id="declaring-proptypes-is-still-fine"></a>
...
#### Don’t call PropTypes directly <a href="#dont-call-proptypes-directly" id="dont-call-proptypes-directly"></a>
...
#### If you don't call PropTypes directly but still get the warning <a href="#if-you-dont-call-proptypes-directly-but-still-get-the-warning" id="if-you-dont-call-proptypes-directly-but-still-get-the-warning"></a>
...
#### Fixing the false positive in third party PropTypes <a href="#fixing-the-false-positive-in-third-party-proptypes" id="fixing-the-false-positive-in-third-party-proptypes"></a>
